  ...
  <div class="flex min-h-screen">
    ...
    >
      ...
      <nav class="flex flex-col space-y-2 text-gray-100 px-2">
        <RouterLink to="/overview" class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-200">
          <Home class="w-5 h-5" />
          <span v-if="!isCollapsed">Overview</span>
        </RouterLink>

        <RouterLink to="/transactions" class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-200">
          <Repeat class="w-5 h-5" />
          <span v-if="!isCollapsed">Transactions</span>
        </RouterLink>

        <RouterLink to="/budgets" class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-200">
          <ChartPie class="w-5 h-5" />
          <span v-if="!isCollapsed">Budgets</span>
        </RouterLink>

        <RouterLink to="/pots" class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-200">
          <Receipt class="w-5 h-5" />
          <span v-if="!isCollapsed">Pots</span>
        </RouterLink>

        <RouterLink to="/recurring" class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-200">
